...
__all__ = [ 'FONTITALIC', 'FONTSTRIKETHROUGH', 'Default', 'OLE_COLOR',
           'OLE_YPOS_CONTAINER', 'LoadPictureConstants', 'Picture',
           'FONTBOLD', 'Color', 'Checked', 'OLE_HANDLE', 'FONTNAME',
           'FONTUNDERSCORE', 'OLE_XSIZE_PIXELS', 'IPictureDisp',
           'IFontEventsDisp', 'VgaColor', 'IFontDisp',
           'OLE_YSIZE_PIXELS', 'IPicture', 'Font',
           'OLE_XPOS_CONTAINER', 'OLE_YSIZE_CONTAINER', 'IFont',
           'OLE_YPOS_PIXELS', 'FONTSIZE', 'OLE_XPOS_PIXELS',
           'Monochrome', 'OLE_TRISTATE', 'OLE_YSIZE_HIMETRIC', 'Gray',
           'Unchecked', 'OLE_XSIZE_CONTAINER', 'OLE_XPOS_HIMETRIC',
           'OLE_OPTEXCLUSIVE', 'OLE_CANCELBOOL', 'StdPicture',
           'StdFont', 'FontEvents', 'OLE_ENABLEDEFAULTBOOL',
